...
\section{Work Experience}
	...
	\explanationdetail{ 
		\smallskip 
		\coloredbullet\ %
		Continue developing and maintaining the State Farm Mobile App as an Android developer.
	...
	\explanationdetail{ 
		...
		\smallskip
		\coloredbullet\ %
		Revamped FAQs in the app using Kotlin and Jetpack Compose, which involved modernizing code and improving scalability.

		\smallskip
		\coloredbullet\ %
		 Migrated legacy Java code to Kotlin, which improved code maintainability and support for new feature.
...
\section{Notable Projects}
	...
	\explanationdetail{
		\smallskip 
		\coloredbullet\ %
		Independently built Android apps for finding the calculating values of resistors, capacitors, and inductors.
		...
		\smallskip
		\coloredbullet\ %
		Combined 60,000+ downloads across all three apps on the \href{https://play.google.com/store/apps/developer?id=Brandon+Cano}{Google Play store}.
	...
	\explanationdetail{
		...
		\smallskip 
		\coloredbullet\ %
		The application recommend exercises and stretches during work hours and automatically schedules these activities in Outlook calendar.
